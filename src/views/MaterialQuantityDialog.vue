...
const volumeUnits = [
	...
	{ value: 'INCH3', label: 'in3' },
	{ value: 'LITER', label: 'L' },
	{ value: 'METER3', label: 'm3' },
	{ value: 'MM3', label: 'mm3' },
	{ value: 'YARD_CUBE', label: 'yard3' },
	{ value: 'brl', label: 'brl' },
	{ value: 'gal', label: 'gal' },
	{ value: 'CUBIC_DECIMETER', label: 'dm3' },
	{ value: 'US_Fluid_Ounce', label: 'FO' },
	{ value: 'CENTILITER', label: 'cL' },
	{ value: 'DECILITER', label: 'dL' },
	{ value: 'MICROLITER', label: 'micL' },
	{ value: 'MILE3', label: 'mi3' },
...
const massUnits = [
	...
	{ value: 'KGFxS2_CM', label: 'kgfxs2_cm' },
	{ value: 'KGFxS2_M', label: 'kgfxs2_m' },
	{ value: 'KGFxS2_MM', label: 'kgfxs2_mm' },
	{ value: 'KILOGRAM', label: 'kg' },
	{ value: 'LBFxS2_FT', label: 'lbfxs2_ft' },
	{ value: 'LBFxS2_IN', label: 'lbfxs2_in' },
	{ value: 'MG', label: 'mg' },
